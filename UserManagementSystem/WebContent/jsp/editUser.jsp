...
<%@page import="com.bridgelabz.usermanagement.model.UserPermissions"%>
<!DOCTYPE html>
<html>
<head>
...
<%
		...
		UserPermissions permissions = (UserPermissions) request.getAttribute("permissions");
	%>
	<div id="wrapper">
		<!-- NAVBAR -->
		...
		<div class="body-content">
			...
			<div class="main-content" style="margin-bottom: 50px; padding-bottom: 50px">
        		...
        		<form id="user-form" class="user-form" action="EditUser?userId=<%=user.getUser_id()%>" method="post" onsubmit="return validatePassword(this)">
        		<div class="container-fluid">
                            		...
                            		<div class="row">
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                                    		<div class="form-group">
                                        		...
                                        		<input name="f_name" value="<%=user.getFirst_name()%>" type="text" id="f_name" required pattern="^[a-zA-Z ]{3,40}$"  tabindex="1" class="form-control" title="The first name must be more than 3 and less than 40 characters long.">
                                    		</div>
                                		</div>
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
		                                        <label for="txtMiddleName" class="control-label">Middle Name</label>
		                                        <input name="m_name" value="<%=user.getMiddle_name()%>" type="text" id="m_name" tabindex="2" class="form-control">
		                                    </div>
		                                </div>
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
		                                        <label for="txtLastName" class="control-label">Last Name</label>
		                                        <input name="l_name" value="<%=user.getLast_name()%>" type="text" id="l_name" placeholder=" " required pattern="^[a-zA-Z ]{3,40}$" tabindex="3" class="form-control"  title="The last name must be more than 3 and less than 40 characters long.">
		                                    </div>
		                                </div>
                            		</div>
                            		<div class="row">
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                                    		<div class="form-group">
                                        		...
                                        		<div class="input-group date" id="dtpDob">
                                            		<input name="dob" value="<%=user.getDob()%>" type="date" id="dob" tabindex="4" class="form-control" placeholder="" required >
                                		...
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                                    		<div class="form-group">
                                        		...
                                        		<select name="gender" id="gender" value="<%=user.getGender()%>" tabindex="-1" class="form-control">
													<option value="" disabled selected>--- Select ---</option>
													<option value="Male" <c:if test="${user.getGender() == 'Male'}"> selected </c:if>>Male</option>
													<option value="Female" <c:if test="${user.getGender() == 'Female'}"> selected </c:if>>Female</option>
												</select>
											</div>
                                		</div>
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                            		...
                            		<div class="row">
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                                    		<div class="form-group">
                                        		...
                                        		<input name="phon" value="<%=user.getPhone()%>" type="text" id="phon" tabindex="7" class="form-control" pattern="^\d{10}$" required title="Mobile number must contain 10 digit">
		                            ...
		                            <div class="row">
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="email" value="<%=user.getEmail()%>" type="email" id="email" tabindex="9" class="form-control" required pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" >
		                                    </div>
		                                </div>
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
		                                        <label for="txtAddress" class="control-label">Address</label>
		                                        <textarea name="address" rows="5" cols="20" id="address" tabindex="10" class="form-control" title="The address should not be more than 200 characters long."><%=user.getAddress()%></textarea>
		                                    </div>
		                                </div>
		                            </div>
                            		<hr>
		                            <div class="row">
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="username" type="text" id="username" tabindex="11" value="<%=user.getUsername()%>" class="form-control" title="The username must be more than 6 and less than 30 characters long.">
		                                    </div>
		                                </div>
		                                <div class="col-md-4 col-sm-6 col-xs-12">
		                                    <div class="form-group">
                                		...
                                		<div class="col-md-4 col-sm-6 col-xs-12">
                                    		<div class="form-group">
                                        		...
                                        		<select name="role" id="role" tabindex="14"  class="form-control" required onchange="setPermissions();" title="Choose any user role.">
													...
													<option value="admin" <c:if test="${user.getUser_role() == 'admin'}"> selected </c:if> >Admin</option>
													<option value="user" <c:if test="${user.getUser_role() == 'user'}"> selected </c:if> >User</option>
					...
					<div class="row" style="padding: 10px 0">
                		<div class="col-md-12 text-center">
                    		<input type="submit" name="btnSubmit" value="Update" id="btnSubmit" tabindex="17" class="btn btn-primary">
                    		<span></span>
